...
console.log(p) */
/*****************  评论 *************/
var swiper = new Swiper('#pinglun .swiper-container', {
  slidesPerView: 3,
  spaceBetween:15,
  slidesPerGroup: 3,
  loop: false,
  ...
  navigation: {
    nextEl: '#pinglun .swiper-button-next',
    prevEl: '#pinglun .swiper-button-prev',
  },
});

/*****************  加入购物车 *************/
/* $('.cake>div').children('p').eq(1).find('a').click(function(){
  tanchuan()
  console.log(this);
})
var red=document.querySelector('.buy')
console.log(red);
 */
//弹框和遮罩层
/* function Mask(){
